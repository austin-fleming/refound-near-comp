...
impl Contract {
    #[payable]
    pub fn create_factory_subaccount_and_deploy_whitelist(
        &mut self,
        name: String,
        foundation_account_id: AccountId,
        ...
        let contract_bytes = self.whitelist_code.len() as u128;
        ...
        let init_args = near_sdk::serde_json::to_vec(&WhitelistInitArgs {
        ...
        let mut promise = Promise::new(subaccount.clone())
            .create_account()
            .transfer(attached)
            .deploy_contract(self.whitelist_code.clone())
        ...
        promise.then(
            Self::ext(env::current_account_id())
                .create_factory_subaccount_and_deploy_whitelist_callback(
                    subaccount,
    ...
    #[private]
    pub fn create_factory_subaccount_and_deploy_whitelist_callback(
        &mut self,
        account: AccountId,
        user: AccountId,
        attached: Balance,
