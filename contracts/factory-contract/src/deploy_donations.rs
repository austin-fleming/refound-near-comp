...
impl Contract {
    #[payable]
    pub fn create_factory_subaccount_and_deploy_donations(
        &mut self,
        name: String,
        beneficiary: AccountId,
        ...
        let contract_bytes = self.donation_code.len() as u128;
        ...
        promise.then(
            Self::ext(env::current_account_id())
                .create_factory_subaccount_and_deploy_donations_callback(
                    subaccount,
    ...
    #[private]
    pub fn create_factory_subaccount_and_deploy_donations_callback(
        &mut self,
        account: AccountId,
        user: AccountId,
        attached: Balance,
