...
struct VotingInitArgs {}

#[near_bindgen]
impl Contract {
    #[payable]
    pub fn create_factory_subaccount_and_deploy_voting(
        &mut self,
        name: String,
        ...
        let contract_bytes = self.voting_code.len() as u128;
        ...
        let init_args = near_sdk::serde_json::to_vec(&VotingInitArgs {}).unwrap();

        let mut promise = Promise::new(subaccount.clone())
            .create_account()
            .transfer(attached)
            .deploy_contract(self.voting_code.clone())
        ...
        promise.then(
            Self::ext(env::current_account_id())
                .create_factory_subaccount_and_deploy_voting_callback(
                    subaccount,
    ...
    #[private]
    pub fn create_factory_subaccount_and_deploy_voting_callback(
        &mut self,
        account: AccountId,
        user: AccountId,
        attached: Balance,
